...
func RegisterMedicalRecordsRoutes(rg *gin.RouterGroup) {

	{
		...
		rg.DELETE("/soft-delete/:id", utils.RoleChecker(models.RoleAdmin, models.RoleDoctor), medicalrecords.SoftDeleteMedicalRecord)
		rg.DELETE("/hard-delete/:id", utils.RoleChecker(models.RoleAdmin), medicalrecords.HardDeleteMedicalRecord)
	}
}
